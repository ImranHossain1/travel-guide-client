        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          <Zoom bottom>
            <div className="">
              <img
                src={destination.img}
                className="max-w-xs rounded-lg shadow-2xl pics"
              />
            </div>
          </Zoom>
          <div className="flex flex-col items-center">
            <Fade left cascade>
              <h1 className="text-5xl font-bold text-orange-500 uppercase">
              ...
              <div
                className="tooltip tooltip-danger mt-5"
                data-tip={`Confirm your Booking for ${destination.destinationName}`}
              >
                <label
